...
public class ComponentBounds2 extends JFrame implements ActionListener {
    ...
    public ComponentBounds2() {
        ...
        bereich1.setPreferredSize(new Dimension(0, 36)); // only height
   	 	...
   	 	button.setBounds(144, 5, 105, 26);       // x, y, width, height
   	 	button.setPreferredSize(new Dimension(105, 26)); // set new size
   	 	
   	 	buttona = new JButton("Schaltfläche");
	 	buttona.setBounds(300, 5, 105, 26);       // x, y, width, height
	 	buttona.setPreferredSize(new Dimension(105, 26)); // set new size
        
   	 	bereich1.add(button);
   	 	bereich1.add(buttona);
	...
	public void actionPerformed(ActionEvent e) {
        ...
        Dimension dba = buttona.getPreferredSize();   // height = 26, width = 105
        Point pa      = buttona.getLocation();        // x = 193, y = 5


        if (cmd.equals(PLUS)) {
            db.width += 20; db.height += 20; dp.height += 20; 
            dba.width += 20; dba.height += 20; 
        }
        ...
        buttona.setPreferredSize(dba);
        buttona.setBounds(pa.x, pa.y, dba.width, dba.height);
        windowFlaeche.validate();
	}

    public static void main(String[] args) {
    	new ComponentBounds2();
    }
}
