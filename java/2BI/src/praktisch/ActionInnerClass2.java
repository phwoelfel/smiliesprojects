...
public class ActionInnerClass2 extends JFrame {
    ...
    void init() {
        setTitle("ActionListener in inner class");
        ...
        setFrameLocation(400, 120);
   	 	...
   	 	button2.addActionListener(new InnerActionListener());
     	setVisible(true);
    }
