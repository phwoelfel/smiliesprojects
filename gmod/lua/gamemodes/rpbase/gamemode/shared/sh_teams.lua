...
RP:AddWeapon("weapon_smg1", 100, {2,3}, "SMG", "models/weapons/w_smg1.mdl", {"smg1", 30});
RP:AddWeapon("weapon_ak47", 100, {3}, "AK-47", "models/weapons/w_rif_ak47.mdl", {"smg1", 30});
RP:AddWeapon("weapon_m4", 100, {3}, "M16", "models/weapons/w_rif_m4a1.mdl", {"smg1", 30});
RP:AddWeapon("weapon_mp5", 100, {2,3}, "MP5", "models/weapons/w_smg_mp5.mdl", {"smg1", 30});
RP:AddWeapon("weapon_pumpshotgun", 100, {3}, "M3", "models/weapons/w_shot_m3super90.mdl", {"buckshot", 10});
...
RP:AddAmmo("SMG1", 150, {2,3}, "SMG Ammo", "models/Items/BoxSRounds.mdl", 100);
RP:AddAmmo("SMG1_Grenade", 50, {2,3}, "SMG Grenade", "models/Items/AR2_Grenade.mdl", 10);
RP:AddAmmo("buckshot", 50, {2,3}, "Shotgun Ammo", "models/Items/BoxBuckshot.mdl", 25);
